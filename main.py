...
app = Flask(__name__)
app.secret_key = "jiotube_v87_advanced"

# --- DB & API Setup (No Changes) ---
...
def index():
    ...
    try:
        # Advanced: Agar search query hai, toh hum prefix ka use karke dhoondenge
    ...
    return f'''{STYLE}
    <div class="header"><b>JioTube</b><div style="display:flex; gap:4px;"><a href="/yt_search" class="btn btn-yt">YOUTUBE</a><a href="/pdf_home" class="btn btn-jio">PDF</a><a href="/ai_chatter" class="btn btn-jio">AI</a></div></div>
    <form style="padding:10px;"><input name="q" placeholder="Advanced Search Saved Videos..." value="{q}"><button class="btn btn-jio" style="width:100%; margin-top:5px;">SEARCH GALLERY</button></form>
    {v_html}{n_btn}'''
...
def yt_search():
    ...
    <div style="padding:10px;">
        <div class="card" style="padding:15px; text-align:center;">
            <a href="https://duckduckgo.com/?q=youtube+videos&iar=videos" target="_blank" class="btn btn-yt">OPEN DUCKDUCKGO ENGINE</a>
            <hr>
